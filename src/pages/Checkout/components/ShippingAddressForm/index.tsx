...
export function ShippingAddressForm() {
  const { order, isFetching, updateOrder, getUserAddressBasedOnZipCode } = useCoffeeOrder();
  ...
  return (
    <ShippingAddressFormContainer>
      ...
      {isFetching ? (
        <LoadingSpinner color="yellow-700" />
      ) : (
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              if (e.target.value?.length === 9) {
                getUserAddressBasedOnZipCode(e.target.value);
              }
            }}
          />
          <Input
